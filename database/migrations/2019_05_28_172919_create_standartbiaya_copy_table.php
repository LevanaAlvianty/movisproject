...
class CreateStandartbiayaCopyTable extends Migration {
	...
	public function up()
	{
		Schema::create('standartbiaya_copy', function(Blueprint $table)
		{
			$table->integer('id_standartbiaya', true);
			$table->string('namabarang', 191)->nullable();
	...
	{
		Schema::drop('standartbiaya_copy');
	}
