<div class="row justify-content-end">
    <div class="col-sm-3" id="kode">
        <input type="text" class="form-control form-control-sm mr-sm-2" id="kodeunit1" placeholder="Masukkan Kode Unit">
    </div>
</div><br><br>
...
<div class="row justify-content-center">
    ...
    <div class="col-sm-5 mb-2">
        <input type="text" class="form-control form-control-sm" id="nip1" placeholder="NIP">
    </div>
</div><br><br>
...
$(document).ready(function(){
    ...
    $( "#kodeunit1" ).autocomplete({
        ...
        select: function(event, ui) {
            event.preventDefault();
            $('#kodeunit1').val(ui.item.value);
            
        }
    });  

    //ketuapelaksana
    $('#ketuplak1').autocomplete({
        ...
        select: function(event, ui) {
            ...
            $('#ketuplak1').val(ui.item.label);
            $('#nip1').val(ui.item.value);
