...
<div class="form-group row">
    <div class="col-sm-12 mb-4">
        ...
        <textarea class="form-control mx-auto mb-2 latar" id="latarlap1" rows="3" placeholder=""></textarea>
    ...
    <div class="col-sm-12 mb-4">
        ...
        <textarea class="form-control mx-auto latar" id="latarlap2" rows="3" placeholder=""></textarea>
        <div class="row justify-content-end">
            <label for="formGroupExampleInput" class="col-sm-3">Minimal 5 kalimat</label>
        </div>
    </div>
    <div class="col-sm-12 mb-4">
        ...
        <textarea class="form-control mx-auto latar" id="latarlap3" rows="3" placeholder=""></textarea>
        <div class="row justify-content-end">
            <label for="formGroupExampleInput" class="col-sm-3">Minimal 5 kalimat</label>
        </div>
    </div>
