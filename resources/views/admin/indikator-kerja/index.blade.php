                                    ...
                                    <table class="table table-bordered table-striped dt-responsive " id="tabelindikator">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$i->dirkegiatan}}</td> 
                                                <td>
                                                    <a href="{{ route('indikator.edit', $i->id_dirkegiatan) }}" class="btn btn-sm btn-primary"><i class="icon fa fa-edit"></i> Ubah</a>
                                                    <a href="{{ route('indikator.show', $i->id_dirkegiatan) }}" class="btn btn-sm btn-warning"><i class="icon fa fa-eye"></i> Detail</a>
                                                    <button class="btn btn-sm btn-danger" data-kegiatanid="{{$i->id_dirkegiatan}}" data-toggle="modal" data-target="#deleteData"><i class="icon fa fa-trash"></i> Hapus</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
