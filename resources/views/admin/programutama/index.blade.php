                                    ...
                                    <table class="table table-bordered table-striped dt-responsive " id="tabelprogram">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('programutama.edit', $p->id_dirprogutama) }}" class="btn btn-sm btn-primary"><i class="icon fa fa-edit"></i> Ubah</a>
                                                    <a href="{{ route('programutama.show', $p->id_dirprogutama) }}" class="btn btn-sm btn-warning"><i class="icon fa fa-eye"></i> Detail</a>
                                                    <button class="btn btn-sm btn-danger" data-progid="{{$p->id_dirprogutama}}" data-toggle="modal" data-target="#deleteData"><i class="icon fa fa-trash"></i> Hapus</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
